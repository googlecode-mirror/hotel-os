...
// -------------------------------------- infoBox ----------
  class infoBox extends tableBox {
    ...
    function infoBoxContents($contents) {
      $this->table_cellpadding = '0';
      $this->table_parameters = ' style="margin-bottom:4px;" class="box_body_table"';
      $info_box_contents = array();
      for ($i=0, $n=sizeof($contents); $i<$n; $i++) {
        $info_box_contents[] = array(  array('align' => (isset($contents[$i]['align']) ? $contents[$i]['align'] : ''),
                                             'form' => (isset($contents[$i]['form']) ? $contents[$i]['form'] : ''),
                                             'params' => ' class="box_body" style="background:url(images/box_corn_tc.gif) bottom repeat-x #ffffff;border:1px solid #adaaaa;border-width:0px 1px 0px 1px;padding:10px 27px 10px 27px;"',
											 'text' => ''.(isset($contents[$i]['text']) ? $contents[$i]['text'] : '').''));
        $info_box_contents[] = array(  array('params' => '',
											 'text' => ''.tep_image(DIR_WS_IMAGES.'line3.gif').''));											 
      }
...
// -------------------------------------- infoBox2 ----------
  class infoBox2 extends tableBox {
    ...
    function infoBoxContents($contents) {
      $this->table_cellpadding = '0';
      $this->table_parameters = ' style="margin-bottom:4px;" class="box_body_table_2"';
      $info_box_contents = array();
      for ($i=0, $n=sizeof($contents); $i<$n; $i++) {
        $info_box_contents[] = array(  array('align' => (isset($contents[$i]['align']) ? $contents[$i]['align'] : ''),
                                             'form' => (isset($contents[$i]['form']) ? $contents[$i]['form'] : ''),
                                             'params' => ' class="box_body" style="padding:0px 27px 15px 27px;"',
											 'text' => ''.(isset($contents[$i]['text']) ? $contents[$i]['text'] : '').''));
        $info_box_contents[] = array(  array('params' => '',
											 'text' => ''.tep_image(DIR_WS_IMAGES.'line1.gif').''));											 
      }
...
// -------------------------------------- infoBoxHeading3 ----------
  class infoBoxHeading3 extends tableBox {
    function infoBoxHeading3($contents, $left_corner = true, $right_corner = true, $right_arrow = false) {
      ...
      $info_box_contents = array();
      $info_box_contents[] = array(array('params' => '',
                                         'text' => ''.tep_image(DIR_WS_IMAGES.'box_corn_l_3.gif').''),
									(array('params' => ' style="width:100%;" class="box_heading_td_3"',
                                         'text' => ''.$contents[0]['text'].'')),
									(array('params' => '',
                                         'text' => ''.tep_image(DIR_WS_IMAGES.'box_corn_r_3.gif').'')));
      $this->tableBox($info_box_contents, true);
    }
  } 
// -------------------------------------- infoBox3 ----------
  class infoBox3 extends tableBox {
    ...
    function infoBoxContents($contents) {
      $this->table_cellpadding = '0';
      $this->table_parameters = ' style="margin-bottom:4px;" class="box_body_table_3"';
      $info_box_contents = array();
      for ($i=0, $n=sizeof($contents); $i<$n; $i++) {
        $info_box_contents[] = array(  array('align' => (isset($contents[$i]['align']) ? $contents[$i]['align'] : ''),
                                             'form' => (isset($contents[$i]['form']) ? $contents[$i]['form'] : ''),
                                             'params' => ' class="box_body" style="padding:0px 27px 15px 27px;background:url(images/bg_22.gif) left bottom no-repeat;"',
											 'text' => ''.(isset($contents[$i]['text']) ? $contents[$i]['text'] : '').''));
        $info_box_contents[] = array(  array('params' => '',
											 'text' => ''.tep_image(DIR_WS_IMAGES.'line2.gif').''));											 
      }
...
// -------------------------------------- infoBoxHeading4 ----------
  class infoBoxHeading4 extends tableBox {
    function infoBoxHeading4($contents, $left_corner = true, $right_corner = true, $right_arrow = false) {
      $this->table_cellpadding = '0';
      $this->table_parameters = ' class="box_heading_table_2"';
      if ($left_corner == true) {
        $left_corner = tep_image(DIR_WS_IMAGES . 'infobox/corner_left.gif');
...
// -------------------------------------- infoBox4 ----------
  class infoBox4 extends tableBox {
    function infoBox4($contents) {
      $info_box_contents = array();
      $info_box_contents[] = array('text' => $this->infoBoxContents($contents));
      $this->table_cellpadding = '0';
      $this->table_parameters = '';
    ...
    function infoBoxContents($contents) {
      ...
      for ($i=0, $n=sizeof($contents); $i<$n; $i++) {
        $info_box_contents[] = array(  array('align' => (isset($contents[$i]['align']) ? $contents[$i]['align'] : ''),
                                             'form' => (isset($contents[$i]['form']) ? $contents[$i]['form'] : ''),
                                             'params' => ' class="box_body" style="padding:0px 7px 0px 7px;"',
											 'text' => ''.(isset($contents[$i]['text']) ? $contents[$i]['text'] : '').''));
        $info_box_contents[] = array(  array('params' => '',
											 'text' => ''.tep_image(DIR_WS_IMAGES.'line1.gif').''));											 
      }
      ...
      for ($i=0, $n=sizeof($contents); $i<$n; $i++) {
        if (isset($contents[$i]['form']) && tep_not_null($contents[$i]['form'])) $tableBox_string .= $contents[$i]['form'] . "\n";
		 ...
		 if ($i != 0) { $tableBox_string .= '
			<tr><td class="bg_line_x" style="height:1px;" colspan="'.(($x+$x)-1).'">'.tep_draw_separator('spacer.gif', '1', '1').'</td></tr>
          ...
          for ($x=0, $n2=sizeof($contents[$i]); $x<$n2; $x++) {
            if (isset($contents[$i][$x]['text']) && tep_not_null($contents[$i][$x]['text'])) {
				...
				if ($x >= 1){
					...
					if($i == 0) {$tableBox_string .= '<td class="bg_line_y">'.tep_draw_separator('spacer.gif', '11', '1').'</td>';}
					else		{ 
				
				
				
				  $tableBox_string .= '<td class="bg_line_y">'.tep_draw_separator('spacer.gif', '11', '1').'</td>';} 
											}
...
// ------------------ contentBoxHeading ------------------------------
  class contentBoxHeading extends tableBox {
    function contentBoxHeading($contents) {
      ...
      $info_box_contents = array();
      $info_box_contents[] = array( array('params' => '',
                                         	'text' => ''.tep_image(DIR_WS_IMAGES.'cont_corn_tl.gif').''),
									(array(	'params' => ' width="100%" class="cont_heading_td"',
                                         	'text' => ''.$contents[0]['text'].'')),
									(array(	'params' => '',
                                         	'text' => ''.tep_image(DIR_WS_IMAGES.'cont_corn_tr.gif').'')));											
...
// ------------------------------------------------------------ 
  ...
  return $table = '
			<table cellpadding="0" cellspacing="0" border="0" class="cont_heading_table">
				<tr><td>'.tep_image(DIR_WS_IMAGES.'cont_corn_tl.gif').'<td><td style="width:100%" class="cont_heading_td">
  ';
  }
// -------------------------------------- --------------------------
  ...
  {
   return $table =  '
					</td><td>'.tep_image(DIR_WS_IMAGES.'cont_corn_tr.gif').'<td></tr>
			</table>									
   ';
  }
//---------------- contentBoxHeading_ProdNew1 --------------------- 
  class contentBoxHeading_ProdNew1 extends tableBox {
    function contentBoxHeading_ProdNew1($contents) {

      $this->table_cellpadding = '0';
      $this->table_parameters = ' class="cont_heading_table_2"';
      $info_box_contents = array();
      $info_box_contents[] = array(array('params' => '',
                                         	'text' => ''.tep_image(DIR_WS_IMAGES.'cont_corn_tl_2.gif').''),
									(array(	'params' => ' width="100%" class="cont_heading_td_2"',
                                         	'text' => ''.HEADING_TITLE.'')),
									(array(	'params' => '',
                                         	'text' => ''.tep_image(DIR_WS_IMAGES.'cont_corn_tr_2.gif').'')));											
...
// -------------------------------------- --------------------------  
  ...
  echo '<table cellpadding="0" cellspacing="0" border="0"><tr><td>'.tep_image(DIR_WS_IMAGES.'corn_left.gif').'</td><td align=right width="100%">'.tep_image(DIR_WS_IMAGES.'corn_top.gif').'</td></tr></table>
...
echo ' 
						 ...
						 <table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td>'.tep_image(DIR_WS_IMAGES.'cont_corn_bl.gif').'</td>
								<td style="width:100%; background:url(images/cont_corn_bc.gif)">'.tep_draw_separator('spacer.gif', '1', '1').'</td>
								<td>'.tep_image(DIR_WS_IMAGES.'cont_corn_br.gif').'</td>
							</tr>
						</table> 						
						';
}
...
// -------------------------------------- --------------------------
// -------------------------------------- --------------------------  
  function tep_draw_heading_top_5()
  {
  echo '
						<table cellpadding="0" cellspacing="0" border="0" class="heading_top_5">
							<tr><td class="padd_55">
								  ';
 			
  }
// -------------------------------------- --------------------------  
function tep_draw_heading_bottom_5()
{
...
echo ' 
						 ...
						 <table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td>'.tep_image(DIR_WS_IMAGES.'cont_corn_bl_2.gif').'</td>
								<td style="width:100%; background:url(images/cont_corn_bc_2.gif)">'.tep_draw_separator('spacer.gif', '1', '1').'</td>
								<td>'.tep_image(DIR_WS_IMAGES.'cont_corn_br_2.gif').'</td>
							</tr>
						</table> 						
...
// -------------------------------------- --------------------------
  ...
  return $table = '
                    <table cellpadding="0" cellspacing="0" border="0" class="pic">
							<tr>
								<td>'.tep_image(DIR_WS_IMAGES.'corn_tl.gif').'</td>
								<td style="width:100%; background:url(images/bg_vv.gif) top left repeat-x">'.tep_draw_separator('spacer.gif', '1', '1').'</td>
								<td>'.tep_image(DIR_WS_IMAGES.'corn_tr.gif').'</td>
							</tr>
                        <tr>
