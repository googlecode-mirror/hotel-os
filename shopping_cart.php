...
<!-- body_text //-->
    <td width="100%" class="col_center"><?php echo tep_draw_form('cart_quantity', tep_href_link(FILENAME_SHOPPING_CART, 'action=update_product')); ?><table border="0"cellspacing="0" cellpadding="0">
      <tr>
        <td>
...
// Push all attributes information in an array
    ...
    for ($i=0, $n=sizeof($products); $i<$n; $i++) {
      ...
      $products_name = ''.tep_draw_separator('spacer.gif', '1', '10').'<br>
	  
					<table cellpadding="0" cellspacing="0" border="0">
						<tr><td>'.tep_draw_separator('spacer.gif', '10', '1').'</td>

							 <td style="height:102px;" align="center" class="vam"><table cellpadding="0" cellspacing="0" border="0" style="width:124px"><tr><td align="center">
      ...
      if (isset($products[$i]['attributes']) && is_array($products[$i]['attributes'])) {
		...
		$products_name .= '												
					...
					</table>'.tep_draw_separator('spacer.gif', '1', '10').'<br>';
...
?>
	...
	<table cellpadding="0" cellspacing="0" border="0"><tr><td class="cart_line_x"><?php echo tep_draw_separator('spacer.gif', '1', '1'); ?></td></tr></table>		
				...
				<table cellspacing="0" cellpadding="0" border="0" >
					<tr>
						<td style="padding:15px 20px 0px 0px;" class="padd33 bg_input"><?php echo tep_image_submit('button_update.gif', IMAGE_BUTTON_UPDATE_CART); ?>   <?php
