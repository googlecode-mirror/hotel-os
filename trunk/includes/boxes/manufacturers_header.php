...
// Display a drop-down
      ...
      $info_box_contents[] = array('form' => tep_draw_form('manufacturers', tep_href_link(FILENAME_DEFAULT, '', 'NONSSL', false), 'get'),
						...
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td style="text-align:center;width:50%;"><br style="line-height:1px;"><br style="line-height:1px;"><strong>'.BOX_HEADING_MANUFACTURERS.':</strong></td>
								<td style="text-align:center;width:50%;">
									'.tep_draw_pull_down_menu('manufacturers_id', $manufacturers_array, (isset($HTTP_GET_VARS['manufacturers_id']) ? $HTTP_GET_VARS['manufacturers_id'] : ''), 'onChange="this.form.submit();" size="' . MAX_MANUFACTURERS_LIST . '"  class="jamp1"') . tep_hide_session_id().'</td>
							</tr>
						</table>												
							');
    }

    new infoBox_77($info_box_contents);
?>
<!-- manufacturers_eof //-->
<?php
  }
