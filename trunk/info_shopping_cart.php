                ...
                <td>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td class="cont_body_tall_l"><?php echo tep_draw_separator('spacer.gif', '1', '1'); ?></td>
                         	<td style="width:100%; border:1px solid #FFFFFF; border-width:16px 5px 0 15px" class="product">
                            	<b><?php echo SUB_HEADING_TITLE_1; ?></b><br><?php echo SUB_HEADING_TEXT_1; ?><br><br style="line-height:11px">
                                        <b><?php echo SUB_HEADING_TITLE_2; ?></b><br><?php echo SUB_HEADING_TEXT_2; ?><br><br style="line-height:11px">
                                        <b><?php echo SUB_HEADING_TITLE_3; ?></b><br><?php echo SUB_HEADING_TEXT_3; ?>
                            </td>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" style="height:68px; background:url(images/bot.gif) repeat-x top" class="footer">
                        <tr>
                            ...
                            <td style="width:100%">
                                <br style="line-height:16px"><?php echo FOOTER_TEXT_BODY?></b>
                            </td>
