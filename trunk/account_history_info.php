...
?>
					<td width="30%" valign="top"><table border="0" width="100%" cellspacing="3" cellpadding="2">
					  <tr>
...
?>
					<tr><td width="<?php echo (($order->delivery != false) ? '70%' : '100%'); ?>" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
					  <tr>
