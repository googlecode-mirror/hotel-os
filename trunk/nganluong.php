...
class NL_Checkout 
{
	...
	// Mã merchante site 
	private $merchant_site_code = '18025';	// Biến này được nganluong.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass= '1194nhan'; // Biến này được nganluong.vn cung cấp khi bạn đăng ký merchant site
