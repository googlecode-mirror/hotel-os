...
-->
                <td class="dataTableHeadingContent" ><?php echo TABLE_HEADING_PRODUCTS_A; ?></td>
                <td class="dataTableHeadingContent" ><?php echo TABLE_HEADING_PRODUCTS_B; ?></td>
                <td class="dataTableHeadingContent" ><?php echo TABLE_HEADING_PRODUCTS_C; ?>&nbsp;</td>
              </tr>
<?php
    $currDate = date("Y-m-d");
    $specials_query_raw = "select * from ".TABLE_STATUS_ROOM." where status_room_current_day = '".$currDate."'";
...
//      }
?>
                <td  class="dataTableContent"><?php echo $specials['status_room_number_room_type_a']; ?></td>
                <td  class="dataTableContent"><?php echo $specials['status_room_number_room_type_b']; ?></td>
                <td  class="dataTableContent"><?php echo $specials['status_room_number_room_type_c']; ?></td>
                <!--
<td  class="dataTableContent" align="right">
                    <span class="oldPrice"><?php //echo $currencies->format($specials['products_price']); ?></span>
                     <span class="specialPrice"><?php //echo $currencies->format($specials['specials_new_products_price']); ?></span></td>
                <td  class="dataTableContent" align="right">
<?php
