...
define('HEADING_TITLE', 'Danh sách phòng trống');

define('TABLE_HEADING_PRODUCTS_A', 'Phòng loại A');
define('TABLE_HEADING_PRODUCTS_B', 'Phòng loại B');
define('TABLE_HEADING_PRODUCTS_C', 'Phòng loại C');
