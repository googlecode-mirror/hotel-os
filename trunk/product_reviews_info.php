...
<?php   echo tep_draw_prod_pic_top();?>													
												...
												<script language="javascript"><!--
document.write('<?php echo '<a href="javascript:popupWindow(\\\'' . tep_href_link(FILENAME_POPUP_IMAGE, 'pID=' . $review['products_id']) . '\\\')">' . tep_image(DIR_WS_IMAGES . $review['products_image'], addslashes($review['products_name']), SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'hspace="0" vspace="0"') . '</a>'; ?>');
//--></script>
...
?>
              ...
              <td height="10"><?php echo tep_draw_separator('spacer.gif', '1', '1'); ?></td>
				<td align="right" width="100%"><a href="<?=tep_href_link(basename($PHP_SELF), tep_get_all_get_params(array('action')) . 'action=buy_now')?>"><?=tep_image_button('button_add_to_cart.gif', IMAGE_BUTTON_IN_CART)?></a></td></tr>
            </table>
				<br style="line-height:1px;"><br style="line-height:10px;">
					<table border="0" width="100%" cellspacing="0" cellpadding="2">
                      <tr>
