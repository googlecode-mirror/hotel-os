...
<div id="gk-main" style="width:<?php echo $this->getColumnWidth('m') ?>%">
     <div class="inner ctop cleft<?php echo $class_main_bottom; ?> cbottom clearfix">
          <?php 
               ...
               <div id="gk-content" style="width:<?php echo $this->getColumnWidth('cw') ?>%">
                    ...
                    <div id="gk-current-content" style="width:<?php echo $this->getColumnWidth('c') ?>%">
						...
						?>
                              ...
                              <div id="component_wrap" class="clearfix gk-mass clear<?php echo ($_GET['option'] === 'com_k2') ? ' k2' : ''; ?><?php echo ($_GET['option'] === 'com_community') ? ' jomsocial' : ''; ?>">
									<div>
